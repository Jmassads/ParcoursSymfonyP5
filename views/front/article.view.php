...
<main class="pt-24">
    ...
    <section class="px-4">
        ...
        <div class="mt-6 d-flex items-center">
    ...
    <section class="mt-4">
        <form class="w-full max-w-xl bg-white rounded-lg px-4 pt-2">
            <div class="d-flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-full d-flex items-start md:w-full px-3">
                    <div class="d-flex items-start w-1/2 text-gray-700 px-2 mr-auto">
                    </div>
                    <div class="-mr-1">
                        <input type="submit"
